...
// Delete Confirmation
extension AlertManager {
    public static func showDeleteConfirmation(on vc: UIViewController) {
        self.showBasicAlert(on: vc, with: "Sorry This Function Is Not Implemented At The Momemnt Please Contact Support", message:  nil)
    }
}
